...
export const authpassword = pgTable("authpassword", {
  id: uuid("id").defaultRandom().primaryKey(),
  userId: text("user_id").notNull(),
 ...
 */
export type NewAuthPassword = typeof authpassword.$inferInsert;
export type AuthPassword = typeof authpassword.$inferSelect;
